        ...
        <div className="flex justify-center items-center">
            ...
            <div className='mt-[12%] w-[400px]'>
                <form className='p-[2rem] rounded-[5px] flex gap-[1rem] flex-col'>
                    ...
                    <input placeholder="Enter Email" className='p-[0.6rem] outline-none w-full bg-inherit border-[1.7px] border-[#333639] focus:border-[#1C9BEF] placeholder:text-[#71767A]' onChange={(e) => setEmail(e.target.value)} required></input>
                    <button className='bg-sky-600 rounded-sm p-2' onClick={sendOTP}>Send OTP</button>
                    <input placeholder="Enter OTP" className='p-[0.6rem] outline-none w-full bg-inherit border-[1.7px] border-[#333639] focus:border-[#1C9BEF] placeholder:text-[#71767A]' onChange={(e) => setEnteredOTP(e.target.value)}></input>
                    <input placeholder="Enter New Password" className='p-[0.6rem] outline-none w-full bg-inherit border-[1.7px] border-[#333639] focus:border-[#1C9BEF] placeholder:text-[#71767A]' onChange={(e) => setPassword(e.target.value)} ></input>
                    <button type="submit" className='bg-sky-600 rounded-sm p-2' onClick={(e) => reset(e)}>Reset</button>
